...
@WebServlet("/journalquerybynotiservlet.do")
public class JournalQueryByNotiServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        journalQueryByNoti mjournalQueryNoti = new journalQueryByNoti();

        String username = request.getParameter("username");
        //String password = request.getParameter("password");
        String result = "";
        //b =mUserLogin.isuserLogin(username, password);
        mJournoteBeanList = mjournalQueryNoti.getJournalByNoti(username);
