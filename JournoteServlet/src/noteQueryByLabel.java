...
public class noteQueryByLabel {
    ...
    public List<JournoteBean> getNoteByLabel(String username, int label) {
        ...
        String sql = "select * from journote where isjournal = 0 and username='"+username+"'and label ="+label+" order by tag desc";
        try {
