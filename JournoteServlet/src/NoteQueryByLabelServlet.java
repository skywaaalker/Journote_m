...
@WebServlet(name = "/notequerybylabelservlet.do")
public class NoteQueryByLabelServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        noteQueryByLabel mNoteQueryByLabel = new noteQueryByLabel();
        ...
        mJournoteBeanList = mNoteQueryByLabel.getNoteByLabel(username, label);
