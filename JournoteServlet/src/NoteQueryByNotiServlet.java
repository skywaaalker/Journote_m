...
@WebServlet("/notequerybynotiservlet.do")
public class NoteQueryByNotiServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        noteQueryByNoti mnoteQueryNoti = new noteQueryByNoti();

        String username = request.getParameter("username");
        //String password = request.getParameter("password");
        String result = "";
        //b =mUserLogin.isuserLogin(username, password);
        mJournoteBeanList = mnoteQueryNoti.getNoteByNoti(username);
