...
public class noteQueryByNoti {
    ...
    public List<JournoteBean> getNoteByNoti(String username) {
        ...
        String sql = "select * from journote where isjournal = 0 and username='"+username+"'and hasnoti= 1  order by tag desc";
        try {
