...
public class journalQueryByNoti {
    ...
    public List<JournoteBean> getJournalByNoti(String username) {
        ...
        String sql = "select * from journote where isjournal = 1 and username='"+username+"'and hasnoti= 1  order by tag desc";
        try {
