...
public class JournoteAdapterNote extends RecyclerView.Adapter<JournoteAdapterNote.JournoteViewHolder> {
  private Context mContext;
  private LayoutInflater mLayoutInflater;
  private List<JournoteBean> mJournoteBeanList;
  private int mEditPosition = -1;

  public JournoteAdapterNote(Context context, List<JournoteBean> mJournoteBeanList){
    mContext = context;
