...
public class AddJournoteActivityNote extends AppCompatActivity {
    ...
    public static void startActivity(Context context, String username){
        Intent intent = new Intent(context, AddJournoteActivityNote.class);
                ...
                case INSERT_JUDGE:{
                    ...
                    try{
                        if (result.equals("success")){
                            Toast.makeText(AddJournoteActivityNote.this,"添加成功！",Toast.LENGTH_SHORT).show();
                        }
    ...
    public void onClick(View view){
        switch (view.getId()){
            case R.id.common2_iv_back:
                ...
                Intent intent = new Intent(AddJournoteActivityNote.this, MainActivityNote.class);
                ...
                if(!title.equals("") || !content.equals("")) {
                  new Thread(new Runnable() {
                    ...
                    public void run() {
                      ...
                      String result = HttpConnnect.noteInsertByPost(title, content, username);
            ...
            case R.id.add_journal_fab_back:
                ...
                //final int authoridBack = intent1.getIntExtra("authorid", 1);
                final String usernameBack = intent_back.getStringExtra("username");
                if(!titleBack.isEmpty() || !contentBack.isEmpty()){
                    AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(this);
                    alertDialogBuilder.setMessage("是否保存笔记内容？").setPositiveButton("确定", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            new Thread(new Runnable() {
                              @Override
                              public void run() {
                                String result = HttpConnnect.noteInsertByPost(titleBack, contentBack, usernameBack);
                                Bundle bundle = new Bundle();
                                ...
                                handler.sendMessage(message);
                                MainActivityNote.startActivity(AddJournoteActivityNote.this, usernameBack);
                              }
                            }).start();
                        }
                    ...
                    MainActivityNote.startActivity(this, usernameBack);
                }
                break;
        }
    }
