...
public class UpdateJournoteActivityNote extends AppCompatActivity {
  ...
  public static void startActivity(Context context, String title, String content, String tag, String username, String date){
    Intent intent = new Intent(context, UpdateJournoteActivityNote.class);
    ...
    public void handleMessage(Message msg){
      ...
      switch (msg.what){
        case DELETE_JUDGE:{
          ...
          try{
            if (result.equals("success")){
              Toast.makeText(UpdateJournoteActivityNote.this,"删除成功！",Toast.LENGTH_SHORT).show();
              //Intent intent =new Intent();
              //MainActivity.startActivity(LoginActivity.this, username);
              Intent intent1 =getIntent();
              String username =intent1.getStringExtra("username");
              Intent intent = new Intent(UpdateJournoteActivityNote.this, MainActivityNote.class);
              intent.putExtra("username",username);
              startActivity(intent);
            }else {
              Toast.makeText(UpdateJournoteActivityNote.this,"删除失败，请重新尝试！",Toast.LENGTH_SHORT).show();
            }
        ...
        case UPDATE_JUDGE:{
          ...
          try{
            if (result.equals("success")){
              Toast.makeText(UpdateJournoteActivityNote.this,"更新成功！",Toast.LENGTH_SHORT).show();
              //Intent intent =new Intent();
              //MainActivity.startActivity(LoginActivity.this, username);
              ...
              Toast.makeText(UpdateJournoteActivityNote.this,"更新失败，请重新尝试！",Toast.LENGTH_SHORT).show();
            }
          }catch (NullPointerException e){
            e.printStackTrace();
          }
        ...
        case DELETE_NOTI_JUDGE:{
          ...
          try{
            if (result.equals("success")){
              Toast.makeText(UpdateJournoteActivityNote.this,"删除提醒成功！",Toast.LENGTH_SHORT).show();
            }else {
              Toast.makeText(UpdateJournoteActivityNote.this,"删除提醒失败，请重新尝试！",Toast.LENGTH_SHORT).show();
            }
          }catch (NullPointerException e){
            e.printStackTrace();
          }
        ...
        case SET_LABEL_0_JUDGE:{
          ...
          try{
            if (result.equals("success")){
              Toast.makeText(UpdateJournoteActivityNote.this,"删除标签成功！",Toast.LENGTH_SHORT).show();
            }else {
              Toast.makeText(UpdateJournoteActivityNote.this,"删除标签失败，请重新尝试！",Toast.LENGTH_SHORT).show();
            }
          }catch (NullPointerException e){
            e.printStackTrace();
          }
        ...
        case SET_LABEL_5_JUDGE:{
          ...
          try{
            if (result.equals("success")){
              Toast.makeText(UpdateJournoteActivityNote.this,"添加标签成功！",Toast.LENGTH_SHORT).show();
            }else {
              Toast.makeText(UpdateJournoteActivityNote.this,"添加标签失败，请重新尝试！",Toast.LENGTH_SHORT).show();
            }
          }catch (NullPointerException e){
            e.printStackTrace();
          }
  ...
  public void onClick(View view){
    switch (view.getId()){
      ...
      case R.id.update_journal_fab_delete:
        ...
        alertDialogBuilder.setMessage("确定要删除该笔记吗？").setPositiveButton("确定", new DialogInterface.OnClickListener() {
          public void onClick(DialogInterface dialog, int which) {
            ...
            Intent intent1 = new Intent(UpdateJournoteActivityNote.this, MainActivityNote.class);
      ...
      case R.id.update_journal_fab_back:
        ...
        Intent intent5 = new Intent(UpdateJournoteActivityNote.this, MainActivityNote.class);
      ...
      public boolean onMenuItemClick(MenuItem item) {
        switch (item.getItemId()) {
          case R.id.menu_noti_setdate:
            Intent intent = new Intent(UpdateJournoteActivityNote.this, DateTimePickerActivityNote.class);
            intent.putExtra("tag", tagAdd);
            intent.putExtra("title", title);
            intent.putExtra("content", content);
            intent.putExtra("username", username);
            startActivityForResult(intent, 1000);
            //DateTimePickerActivity.startActivity(UpdateJournoteActivityNote.this, tagAdd);
            return true;
        ...
        switch (item.getItemId()) {
          ...
          case R.id.menu_label_set3:
            new Thread(new Runnable() {
              @Override
              public void run() {
                String result = HttpConnnect.labelUpdateByPost(tagAdd, 3);
                Bundle bundle = new Bundle();
                bundle.putString("result", result);
                Message message = new Message();
                message.setData(bundle);
                message.what = SET_LABEL_3_JUDGE;
                handler.sendMessage(message);
              }
            }).start();
            return true;
          case R.id.menu_label_set4:
            new Thread(new Runnable() {
              @Override
              public void run() {
                String result = HttpConnnect.labelUpdateByPost(tagAdd, 4);
                Bundle bundle = new Bundle();
                bundle.putString("result", result);
                Message message = new Message();
                message.setData(bundle);
                message.what = SET_LABEL_4_JUDGE;
                handler.sendMessage(message);
              }
            }).start();
            return true;
  ...
  public void onBackPressed(){
    ...
    Intent intent = getIntent();
    String username = intent.getStringExtra("username");
    MainActivityNote.startActivity(this, username);
  }
