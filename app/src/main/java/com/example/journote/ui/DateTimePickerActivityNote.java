    ...
    btn.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View view) {
        if (setNotiDate.getTimeInMillis() < System.currentTimeMillis()){
          Toast.makeText(DateTimePickerActivityNote.this, "请选择现在之后的时间", Toast.LENGTH_SHORT).show();
          return;
        }
    ...
    public void handleMessage(Message msg){
      ...
      switch (msg.what){
        ...
        case INSERT_NOTI_JUDGE:{
          ...
          try{
            if (result.equals("success")){
              Toast.makeText(DateTimePickerActivityNote.this, "添加提醒成功", Toast.LENGTH_SHORT).show();
            } else {
              Toast.makeText(DateTimePickerActivityNote.this, "添加提醒失败", Toast.LENGTH_SHORT).show();
            }
          }catch (NullPointerException e){
            e.printStackTrace();
          }
        ...
        case UPDATE_NOTI_JUDGE:{
          ...
          try{
            if (result.equals("success")){
              Toast.makeText(DateTimePickerActivityNote.this, "更改提醒成功", Toast.LENGTH_SHORT).show();
            }else {
              Toast.makeText(DateTimePickerActivityNote.this, "更改提醒失败", Toast.LENGTH_SHORT).show();
            }
          } catch (NullPointerException e ){
            e.printStackTrace();
          }
        ...
        case TIME_EARLY_JUDGE:{
          try {
            Toast.makeText(DateTimePickerActivityNote.this, "请选择现在之后的时间", Toast.LENGTH_SHORT);
          } catch (NullPointerException e){
            e.printStackTrace();
          }
        }
