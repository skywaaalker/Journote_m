...
public class MainActivityNote extends AppCompatActivity {
    ...
    public static void startActivity(Context context, String username){
        Intent intent = new Intent(context, MainActivityNote.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void handleMessage(Message msg){
                ...
                switch (msg.what){
                    case SELECT_ALL:{
                        ...
                        mMainRvShowJournal.setLayoutManager(new LinearLayoutManager(MainActivityNote.this));
                        mMainRvShowJournal.setAdapter(new JournoteAdapter(MainActivityNote.this, mJournoteBeanList));
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                mJournoteBeanList = HttpConnnect.getnote(username);
        ...
        initTitle();
        mJouranlMainSearchView.setQueryHint("在笔记中搜索");
        //mMainRvShowJournal.setLayoutManager(new LinearLayoutManager(this));
        //mMainRvShowJournal.setAdapter(new JournoteAdapterNote(this, mJournoteBeanList));
    ...
    public void initTitle(){
        ...
        //String username = bundle.getString("username");
        String username = intent.getStringExtra("username");
        mCommonTvTitle.setText(username+"の笔记本");
  ...
  protected void setListeners() {
    mJouranlMainSearchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
      ...
      public boolean onQueryTextChange(String s) {
        ...
        mMainRvShowJournal.setAdapter(new JournoteAdapter(MainActivityNote.this, journoteBeanListFiltered));
        return true;
      }
    });
  ...
  private List<JournoteBean> filter(List<JournoteBean> models, String searchText){
    ...
    @Subscribe
    public void startUpdateJournoteActivityNote(StartUpdateJournoteEvent event){
        ...
        //int id = mJournoteBeanList.get(event.getPosition()).getId();
        ...
        UpdateJournoteActivityNote.startActivity(this, title, content, tag, username, date);
    ...
    public void onClickAddJournote(){
        Intent intent = getIntent();
        String username = intent.getStringExtra("username");
        Intent intent1 = new Intent(MainActivityNote.this, AddJournoteActivityNote.class);
    ...
    public void selectJournoteByNoti(){
        ...
        if (noti_flag) {
            ...
            new Thread(new Runnable() {
                @Override
                public void run() {
                    mJournoteBeanList = HttpConnnect.getnoteByNoti(username);
                    Bundle bundle = new Bundle();
            ...
            public boolean onMenuItemClick(MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.menu_switch_journal:
                        Intent intent = new Intent(MainActivityNote.this, MainActivity.class);
                        intent.putExtra("username",username);
                   ...
                   case R.id.menu_logout:
                    AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(MainActivityNote.this);
                    alertDialogBuilder.setMessage("确定要退出登录吗?").setPositiveButton("确定", new DialogInterface.OnClickListener() {
                      @Override
                      public void onClick(DialogInterface dialogInterface, int i) {
                        SharedPreferences.Editor editor = MainActivityNote.this.getSharedPreferences("LoginStatus", MODE_PRIVATE).edit();
                        editor.putBoolean("isLogin", false);
                        editor.putString("username", "");
                        editor.putString("password", "");
                        editor.apply();
                        Intent intent1 = new Intent(MainActivityNote.this, LoginActivity.class);
                        startActivity(intent1);
                      }
                ...
                switch (item.getItemId()) {
                    case R.id.menu_label_all:
                        ...
                        new Thread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                JournalList = HttpConnnect.getnote(username);
                    ...
                    case R.id.menu_label_1:
                        ...
                        new Thread(new Runnable() {
                            @Override
                            public void run() {
                                mJournoteBeanList = HttpConnnect.getnoteByLabel(username, 1);
                                Bundle bundle = new Bundle();
                    ...
                    case R.id.menu_label_2:
                        ...
                        new Thread(new Runnable() {
                            @Override
                            public void run() {
                                mJournoteBeanList = HttpConnnect.getnoteByLabel(username, 2);
                                Bundle bundle = new Bundle();
                    ...
                    case R.id.menu_label_3:
                        ...
                        new Thread(new Runnable() {
                            @Override
                            public void run() {
                                mJournoteBeanList = HttpConnnect.getnoteByLabel(username, 3);
                                Bundle bundle = new Bundle();
                    ...
                    case R.id.menu_label_4:
                        ...
                        new Thread(new Runnable() {
                            @Override
                            public void run() {
                                mJournoteBeanList = HttpConnnect.getnoteByLabel(username, 4);
                                Bundle bundle = new Bundle();
                    ...
                    case R.id.menu_label_5:
                        ...
                        new Thread(new Runnable() {
                            @Override
                            public void run() {
                                mJournoteBeanList = HttpConnnect.getnoteByLabel(username, 5);
                                Bundle bundle = new Bundle();
